...
def god_classes() -> list:
    """Class names of God."""
    return ['person', 'goldfish', 'great_grey_owl', 'common_iguana', 'goose',
       'black_swan', 'conch', 'Dungeness_crab', 'killer_whale', 'leopard',
       'wombat', 'fly', 'cabbage_butterfly', 'ibex', 'Arabian_camel',
       'bighorn', 'airliner', 'barrow', 'beer_glass', 'croquet_ball',
       'tractor', 'cannon', 'canoe', 'coffeepot', 'horse_cart',
       'cowboy_hat', 'cowboy_hat', 'electric_guitar', 'fire_engine',
       'football_helmet', 'grand_piano', 'stone_wall', 'hand_blower',
       'harp', 'iPod', 'knot', 'mailbox', 'acoustic_guitar', 'microwave',
       'church', 'hatchet', 'coil', 'space_heater', 'snowmobile', 'sock',
       'church', 'drum', 'umbrella', 'tape_player', 'washer',
       'crash_helmet']


def coco_gender_classes() -> list:
    """Class names of COCO."""
    return [
        'person', 'man', 'woman', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train',
        'truck', 'boat', 'traffic_light', 'fire_hydrant', 'stop_sign',
        'parking_meter', 'bench', 'bird', 'cat', 'dog', 'horse', 'sheep',
        'cow', 'elephant', 'bear', 'zebra', 'giraffe', 'backpack', 'umbrella',
        'handbag', 'tie', 'suitcase', 'frisbee', 'skis', 'snowboard',
...
dataset_aliases = {
    ...
    'god': ['god'],
    'coco_gender': ['coco_gender'],
    'coco_gender_age': ['coco_gender_age'],
    'coco_background': ['coco_background'],
    'coco_supercategory_only': ['coco_supercategory_only'],
    'coco_background_only': ['coco_background_only'],
